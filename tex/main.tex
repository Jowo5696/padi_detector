...
\begin{figure}
  ...
  \caption{Exit of ELSA. \cite{ELSA}}
  \label{fig:beam_setup_elsa}
\end{figure}

\begin{figure}
  \includegraphics[width=\linewidth]{figures/detector_setup_elsa.jpg}
  \caption{Setup of the detector and the metal bar, to place the targets on it and align them with the laser. \cite{ELSA}}
...
When plotting $\theta _\text{theo}$ against $\theta _\text{exp}$ (TODO ODER ANDERSRUM) one can see a clear linear relation between these two quantities.
