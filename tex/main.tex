...
Therefore, in the following analysis, only the y-direction is considered.





The collected raw data counts unwanted hits because of different reasons.
First of all, there is a noise on the detector, which is also read out when the scintillators trigger the system. To filter the noise a charge threshold is used.
...
As shown in %\autoref{fig:correlation}, the (...).
...
%\begin{figure}
%  \includegraphics[width=0.9\linewidth]{../src/elsa/finished_plots/}
%  \caption{Correlation between experimental and theoreticle RMS scattering angle.}
...
\section{Disassambled Micromegas Detector}
...
\begin{figure}[h]
  \centering
    ...
    \begin{subfigure}{0.36\textwidth}
        ...
        \label{fig:micromegas_strips}
    \end{subfigure}
    \caption{Pictures of the disassambled micromegas detector.}
...
\begin{figure}[h]
    ...
    \end{subfigure}
    \caption{Counted hits for alumnium of different thicknisses $x$.}
    \label{fig:alu_gaus}
\end{figure}
...
\begin{figure}[h]
    ...
    \begin{subfigure}{0.49\textwidth}
        ...
        \caption{$x\approx3\cdot X_0$}
    \end{subfigure}
    \caption{Counted hits for copper of different thicknisses $x$.}
    \label{fig:cop_gaus}
\end{figure}
