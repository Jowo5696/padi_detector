...
% The scattered beam is broadened this results in increased width of detector plots, and the standard deviation $\sigma$ of this lateral beam profile is related to the angular RMS via simple geometric considerations. 
% Specifically, the relation
% \begin{equation}\label{eq:sigma}
%     \sigma = d \cdot \theta_0
% \end{equation}
% connects the physical spread of the beam. 
...
To achieve this a logic unit with an \textsc{and} operation is used on both discriminated signals.
