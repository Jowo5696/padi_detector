...
The recorded data of cosmic muons yielded a muon flux of approximately \SI{0.09}{\text{µ}\per\centi\meter\squared\per\min}, which is about a factor of 10 smaller than the value in the literature. 
